...
echo "=== [5/7] Phân tích và Vẽ hình Việt hóa cho CNN Gốc ==="
...
echo "=== [6/7] Phân tích và Vẽ hình Việt hóa cho CNN Đối chứng ==="
python3 src/interpret.py \
    --data data/cmd_data_gauss.npz \
    --seeds 0 1 2 \
    --model_prefix cmd_cnn_gauss \
...
echo "=== [7/7] Đồng bộ hóa các biểu đồ mới và Biên dịch lại PDF ==="
